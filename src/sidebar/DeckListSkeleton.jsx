...
const SkeletonItem = () => (
  <div className="ytf-deck-item" style={{ backgroundColor: '#fff', border: '1px solid transparent' }}>
    <div className="ytf-deck-item-main">
      <div className="rd-skeleton rd-skeleton-title"></div>
      <div className="rd-skeleton rd-skeleton-text" style={{ width: '50%' }}></div>
    </div>
